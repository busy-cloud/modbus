module github.com/busy-cloud/modbus
...
require (
	...
	github.com/busy-cloud/boat-ui v0.2.6 // indirect
	github.com/busy-cloud/influxdb v0.2.3 // indirect
	github.com/busy-cloud/user v0.2.3 // indirect
